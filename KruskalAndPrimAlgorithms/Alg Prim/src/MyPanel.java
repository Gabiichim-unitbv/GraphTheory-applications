...
public class MyPanel extends JPanel {
    ...
    public MyPanel() {
        primButton = new JButton("Generate prim tree");
                ...
                if (e.getButton() == MouseEvent.BUTTON1) {
                    ...
                    if (!isDragging) {
                        ...
                        if (isOnNodeStart && isOnNodeEnd && (nodeEnd != nodeStart)) {
                            ...
                            adj[nodeStart][nodeEnd] = Integer.parseInt(weight);
                            adj[nodeEnd][nodeStart] = Integer.parseInt(weight);
                            listaArce.add(arc);
                        }
                    }
                    pointStart = null;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (clicked) {
            ...
            for (Arc a : Graph.newEdgesList) {
                { g.setColor(Color.GREEN);
                    a.drawArc(g);}

                for (Node node : Graph.newNodeList)
